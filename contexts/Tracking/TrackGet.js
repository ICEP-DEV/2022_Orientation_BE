...
Router.post('/', (req, res, next) => {
    ...
    let query = "SELECT tracking.id, student.firstname, student.lastname, student.email, student.studNum, tracking.activity, date_format(datetime, '%d/%m/%Y %h:%i %p') as datetime" +
